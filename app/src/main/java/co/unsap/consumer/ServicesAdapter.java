...
public class ServicesAdapter extends BaseAdapter  {
    Context context;
    ArrayList<Service> menuItems;




    private static LayoutInflater inflater=null;
    public ServicesAdapter(Context mainActivity, ArrayList<Service> menuItems) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load(menuItems.get(position).title_ar).into(holder.country_flag);

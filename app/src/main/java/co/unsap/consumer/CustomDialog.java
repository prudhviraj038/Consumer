...
public abstract class CustomDialog extends Dialog implements
   ...
   public   CustomDialog(Activity a, int alert_type , String tittle, String message) {
        super(a);
   ...
   public   CustomDialog(Activity a, int alert_type , String tittle, String message,boolean atbottom) {
        super(a);
        // TODO Auto-generated constructor stub
        this.c = a;
        this.alert_type = alert_type;
